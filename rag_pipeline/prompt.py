...
Question: {question}
Now, list the subquestions needed to answer the main question, separated by <subtopic> tags.
""".strip()

ADAPTIVE_ROUTER_SEQUENTIAL_PROMPT = """
Original Question: {question}
{references}
Based on the previous subquestions and retrieved contexts, now list additional subquestions needed to answer the main question, separated by <subtopic> tags.
If you think references from previous retrievals are enough to answer the question, respond with <terminate>.
""".strip()
...
ITERATIVE_ROUTER_SQUENTIAL_PROMPT = """
Original Question: {question}
{references}
Based on the previous subquestions and retrieved contexts, now list additional subquestions needed to answer the main question, separated by <subtopic> tags.
""".strip()